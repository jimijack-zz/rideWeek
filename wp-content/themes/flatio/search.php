        ...
        <?php endif; ?>
                ...
                <article id="post-<?php the_ID(); ?>" <?php post_class( 'article' ); ?>>
                    ...
                    <div class="article-meta">
                        ...
                        <div class="alignright"><a href="<?php the_permalink(); ?>" class="article-more"><?php echo __('Read More', 'flatio'); ?></a></div>
                    </div>
                </article>
				<?php endwhile; ?>
				...
				<?php else : ?>
					<article class="search-error">
						<header class="article-header"><h3 class="h3"><?php echo __('Oops, Nothing Found!', 'flatio'); ?></h3></header>
                        <div class="article-body">
							<p><?php echo __( 'Sorry, but nothing matched your search criteria. Please try again with some different keywords.', 'flatio'); ?></p>
                        </div>
						<?php get_search_form(); ?>
                     </article>
				<?php endif; ?>
