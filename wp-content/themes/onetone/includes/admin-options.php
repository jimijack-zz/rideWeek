...
SHINES ONE PAGE SMALL BUSINESS WEBSITE.",
	...
	$section_content_typography_defaults = array(
	 ...
	 $home_sections = array(
							   1 => __('Section 1 -', 'onetone' ),
							   2 => __('Section 2 -', 'onetone' ),
							   3 => __('Section 3 -', 'onetone' ),
							   4 => __('Section 4 -', 'onetone' ),
							   5 => __('Section 5 -', 'onetone' ),
							   6 => __('Section 6 -', 'onetone' ),
							   7 => __('Section 7 -', 'onetone' ),
							   8 => __('Section 8 -', 'onetone' ),
							   9 => __('Section 9 -', 'onetone' ),
