...
<header id="header">	
    ...
    <div class="logo">
		...
		<?php 
		if($chronicle_theme_options['text_title'] =="on")
		{ echo get_bloginfo('name'); }
		else if($chronicle_theme_options['upload_image_logo']!='')	{ ?>
    ...
    <div class="container">
      <div class="navbar-header">
        <div class="navbar-toggle .navbar-collapse .pull-right " data-toggle="collapse" data-target="#navbar-collapse-1"  ><span><?php __('Menu','galaxy') ;?></span>
